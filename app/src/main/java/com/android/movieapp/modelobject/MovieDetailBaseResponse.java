...
public class MovieDetailBaseResponse implements Parcelable {
    ...
    public final static Parcelable.Creator<MovieDetailBaseResponse> CREATOR = new Creator<MovieDetailBaseResponse>() {


        @SuppressWarnings({
                "unchecked"
        })
        public MovieDetailBaseResponse createFromParcel(Parcel in) {
            MovieDetailBaseResponse instance = new MovieDetailBaseResponse();
            ...
            in.readList(instance.genres, (java.lang.Object.class.getClassLoader()));
        ...
        public MovieDetailBaseResponse[] newArray(int size) {
            return (new MovieDetailBaseResponse[size]);
        }
